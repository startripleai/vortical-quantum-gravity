...
Consequently, the real physical Mass-to-Light ratio
$\(M/L)_{\text{real}}$ remains completely aligned with normal standard stellar population synthesis models ( $1 \sim 5 \, \ M_{\odot} / L_{\odot}$ ):
