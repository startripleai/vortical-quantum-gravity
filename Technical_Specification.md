...
During simulation runtime, the Yellow $P_t$ Indicator exhibits stalling and high-frequency oscillation near the $r = 1.0$ mark. This provides an exact numerical mapping of the Lattice Phase Transition:
